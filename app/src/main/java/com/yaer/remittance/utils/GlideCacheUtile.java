 ...
 * 获取Glide 内存和清除
 */
public class GlideCacheUtile {
    private static GlideCacheUtile inst;

    public static GlideCacheUtile getInstance() {
        if (inst == null) {
            inst = new GlideCacheUtile();
        }
        return inst;
    }
    ...
    private static String getFormatSize(double size) {
        ...
        if (teraBytes < 1) {
            ...
            return result3.setScale(2, BigDecimal.ROUND_HALF_UP).toPlainString() + "MB";
        }
        BigDecimal result4 = new BigDecimal(teraBytes);
        return result4.setScale(2, BigDecimal.ROUND_HALF_UP).toPlainString() + "MB";
    }
