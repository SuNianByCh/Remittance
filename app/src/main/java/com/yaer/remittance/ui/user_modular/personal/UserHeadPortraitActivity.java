...
public class UserHeadPortraitActivity extends BaseTakePhotoActivity implements CustomTitlebar.TitleBarOnClickListener {
    ...
    private String name, phone, userheadname;
    ...
    public void initView() {
        ...
        Glide.with(this).load(PersonalIcon).fitCenter().into(iv_userhead);
    ...
    /*修改用户信息头像*/
    private void GetupheadPortrait(String oosuserpath, String userheadname) {
        OkGo.<BaseMode>post(AppApi.BASE_URL + AppApi.UPDATEUSERINF)
                .tag(this)
                .params("uid", uid)
                .params("uname", userheadname)
                .params("utoken", utoken)
                .params("uicon", oosuserpath)
                .execute(new JsonCallback<BaseMode>(this) {
                    ...
                    public void onSuccess(Response<BaseMode> response) {
                        ...
                        if (response.body().code.equals(Constant.SUEECECODE)) {
                            ToastUtils.showShort(UserHeadPortraitActivity.this, response.body().msg);
                            finish();
                        } else {
                            ToastUtils.showShort(UserHeadPortraitActivity.this, response.body().msg);
                        }
            ...
            public void onSuccess(PutObjectRequest request, PutObjectResult result) {
                ...
                if (oosuserpath.equals("")) {
                    ...
                    if (!name.equals("")) {
                        ...
                        userheadname = AppUtile.hideCardNo(phone);
                    }
                    GetupheadPortrait(oosuserpath, userheadname);
                }
