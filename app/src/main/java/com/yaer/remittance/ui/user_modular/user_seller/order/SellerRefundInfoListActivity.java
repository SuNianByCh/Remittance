...
import com.yaer.remittance.ui.user_modular.user_buyer.order.RefundReturnDetailsActivity;
import com.yaer.remittance.ui.user_modular.user_seller.adapter.RefundInfoListSellerAdapter;
 ...
 * 售后
 */
public class SellerRefundInfoListActivity extends BaseActivity {
    @BindView(R.id.et_go)
    TextView et_go;//标题
    @BindView(R.id.back)
    ImageView back;//返回按钮
    ...
    private RefundInfoListSellerAdapter refundInfoListSellerAdapter;
    ...
    public void initView() {
        ...
        RefundInfolist(sid);
        refundInfoListSellerAdapter = new RefundInfoListSellerAdapter();
        rv_refundlinfo_list.setAdapter(refundInfoListSellerAdapter);
                ...
                switch (itemViewId) {
                    case R.id.rl_item_refundinfo:
                       /* goToActivity(RefundActivity.class);
                        ...
                        Intent intent = new Intent(SellerRefundInfoListActivity.this, RefundReturnSellerDetailsActivity.class);
    ...
    public void RefundInfolist(String sid) {
        if (!NetworkUtils.isNetworkConnected(this)) {
            refundInfoListSellerAdapter.setEmptyView(errorView);
        } else {
            OkGo.<BaseMode<List<RefundInfoListBean>>>post(AppApi.BASE_URL + AppApi.GETREFUNDINFOLIST)
                    ...
                    .execute(new JsonCallback<BaseMode<List<RefundInfoListBean>>>(this) {
                        ...
                        public void onStart(Request<BaseMode<List<RefundInfoListBean>>, ? extends Request> request) {
                            ...
                            LoadingDialog.showDialogForLoading(SellerRefundInfoListActivity.this, null);
                        }
                        ...
                        public void onSuccess(Response<BaseMode<List<RefundInfoListBean>>> response) {
                            ...
                            if (refundInfoListBeans.size() == 0) {
                                refundInfoListSellerAdapter.setEmptyView(notDataView);
                            }
                            if (response.body().code.equals(Constant.SUEECECODE)) {
                                refundInfoListSellerAdapter.setNewData(refundInfoListBeans);
                            } else {
                                ToastUtils.showShort(SellerRefundInfoListActivity.this, response.body().msg);
                            }
                        }
