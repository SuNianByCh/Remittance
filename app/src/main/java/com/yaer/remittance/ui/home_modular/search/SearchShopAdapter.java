...
public class SearchShopAdapter extends BaseQuickAdapter<ShopInfoListByKeyBean, BaseViewHolder> {

    public SearchShopAdapter() {
        super(R.layout.search_shop_item);
    }
    @Override
    protected void convert(BaseViewHolder helper, final ShopInfoListByKeyBean item) {
