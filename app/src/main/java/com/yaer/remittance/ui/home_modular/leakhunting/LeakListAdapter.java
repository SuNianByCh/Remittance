...
public class LeakListAdapter extends BaseQuickAdapter<LeakHuntingBean, BaseSimpleViewHolder> {
    ...
    @Override
    protected void convert(BaseSimpleViewHolder helper, final LeakHuntingBean item) {
      ...
      //  helper.setText(R.id.tv_person_number, item.getGoodsInfoModels().getGisauction() + "人");
        ...
        helper.addOnClickListener(R.id.ll_leak_list);
