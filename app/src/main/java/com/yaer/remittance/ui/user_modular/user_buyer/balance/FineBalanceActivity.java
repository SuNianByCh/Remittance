 ...
 * 余额明细
 */
public class FineBalanceActivity extends BaseActivity implements CustomTitlebar.TitleBarOnClickListener {
    ...
    private String[] titles1 = new String[]{"充值", "提现","消费", "平台收入","冻结","退款"};
 ...
 /*   private DetailedRechargeFragment;//充值
    ...
    public void initData() {
        ...
        nl_fine_balance.setViewPager(this, titles1, viewPager1, R.color.text_danhui_color, R.color.main_tone, 14, 14, 0, 20, true);
