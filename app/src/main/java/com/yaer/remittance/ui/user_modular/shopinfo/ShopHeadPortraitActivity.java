...
public class ShopHeadPortraitActivity extends BaseTakePhotoActivity implements CustomTitlebar.TitleBarOnClickListener {
    ...
    public void initView() {
        ...
        PersonalIcon = getIntent().getStringExtra("shopimg");
                ...
                .execute(new JsonCallback<BaseMode>(this) {
                    ...
                    public void onSuccess(Response<BaseMode> response) {
                        ...
                        if (response.body().code.equals(Constant.SUEECECODE)) {
                            ToastUtils.showShort(ShopHeadPortraitActivity.this, response.body().msg);
                            finish();
                        } else {
                            ToastUtils.showShort(ShopHeadPortraitActivity.this, response.body().msg);
                        }
