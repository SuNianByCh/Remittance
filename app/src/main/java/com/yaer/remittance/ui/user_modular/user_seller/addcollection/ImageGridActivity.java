...
//                    mImageGridAdapter.refreshData(imageFolder.images);
                    ...
                    for (int i = 0; i <imageFolder.images.size() ; i++) {
                        if(imageFolder.images.get(i).path.endsWith("gif")){
                            imageFolder.images.remove(i);
                        }
                    }
...
//            mImageGridAdapter.refreshData(imageFolders.get(0).images);
            for (int i = 0; i <imageFolders.get(0).images.size() ; i++) {
                if(imageFolders.get(0).images.get(i).path.endsWith("gif")){
                    imageFolders.get(0).images.remove(i);
                }
            }
