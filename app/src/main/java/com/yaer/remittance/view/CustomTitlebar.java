...
/**
 * @link https://xiaohaibin.github.io/ @email： xhb_199409@163.com
 * @github: https://github.com/xiaohaibin @description： 封装好的通用标题栏控件
 */
public class CustomTitlebar extends RelativeLayout implements View.OnClickListener {
     ...
     * 中间保存按钮的资源图片
     */
    private int title_button_image_id;
    /**
     * 右边保存按钮的文字
     */
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        /** 标题相关 */
        title_background_color = typedArray.getColor(R.styleable.CustomTitlebar_title_backgrounds, Color.WHITE);
        ...
        title_button_image_id = typedArray.getResourceId(R.styleable.CustomTitlebar_title_button_image, 0);
        ...
        setTitleIcon(title_button_image_id);
     ...
     * @param
     */
    public void setShow_title_button(boolean show_title_button) {
        mIvTitle.setVisibility(show_title_button ? VISIBLE : INVISIBLE);
        mIvTitle.setVisibility(show_title_button ? VISIBLE : INVISIBLE);
    }
